...
Shared Reward is a task involving a participant in a neuropsychological study guessing whether the number on a playing card will be higher or lower than 5. If their guess is correct, money is added to a bank and shared with them and a partner displayed on the top of the screen. If their guess is incorrect, money is subtracted from the bank. While the task is within an fMRI, this folder contains analyses of, you guessed it, only the Behavioral aspects.
