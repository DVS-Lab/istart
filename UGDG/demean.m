...
data = (path + "sub-" + subj + "run-0" + r + ".bids_cue_ug-resp_parametric.txt");
...
data = (path + "sub-" + subj + "run-0" + r + ".bids_cue_ug-prop_parametric.txt");
...
data = (path + "sub-" + subj + "run-0" + r + ".bids_cue_dict_parametric.txt");
