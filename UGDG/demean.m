...
output = "sub-" + subj + "run-0" + r + "_cue_ug-resp_parametric_pmod_demeaned.txt";
...
output = "sub-" + subj + "run-0" + r + "_cue_ug-prop_parametric_pmod_demeaned.txt";
...
output = "sub-" + subj + "run-0" + r + "_cue_dict_parametric_pmod_demeaned.txt";
